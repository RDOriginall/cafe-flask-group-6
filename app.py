...
app.add_url_rule('/cashier/menu_item', 'menu_item', menu_item, methods=['GET'])
# new
app.add_url_rule('/comment/', 'comment', comment, methods=['POST'])
app.add_url_rule('/add_order/', 'add_order', add_order, methods=['POST'])
app.add_url_rule('/get_tables/', 'get_tables', get_tables, methods=['GET'])
app.add_url_rule('/cashier/menu/', 'cashier_menu', cashier_menu, methods=['GET'])
app.add_url_rule('/edit_menu_item/', 'edit_menu_item', edit_menu_item, methods=['POST'])
